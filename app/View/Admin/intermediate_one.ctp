                                                                            ...
                                                                            <div class="input-group">
                                                                                <div class="icheck-inline">
                                                                                    <?foreach($associations as $association):?>
                                                                                        ...
                                                                                        <label>
                                                                                            <input type="checkbox" name="tab[<?echo $store['KaikakeStore']['id']?>][]" value="<?echo $association['Association']['id']?>" class="icheck" data-checkbox="icheckbox_square-blue" <?if($flag==1){echo "checked";}?>> <?echo $association['Location']['name'];?>（<?echo $association['Attribute']['name'];?>）
                                                                                        </label>
                                                                                    <?endforeach;?>
                                                                                </div>
                                                                            </div>
