    ...
    return {
        ...
        initPieCharts: function(s, y) {
            ...
            */
            ...
            /*sushi*/
            var s_data = [];
            var p1 = Math.floor(s.itaba_sales / s.total_sales * 100) + 1;
            var p2 = Math.floor(s.yakiba_sales / s.total_sales * 100) + 1;
            var p3 = Math.floor(s.drink_sales / s.total_sales * 100) + 1;
            s_data[0] = {
                label: "板場", 
                data: p1
            };
            ...
            /*yakiniku*/
            var y_data = [];
            console.log(y.itaba_sales);
            var p4 = Math.floor(y.yakiba_sales / y.total_sales * 100) + 1;
            var p5 = Math.floor(y.drink_sales / y.total_sales * 100) + 1;
            y_data[0] = {
                label: "調理場", 
                data: p4
            };
