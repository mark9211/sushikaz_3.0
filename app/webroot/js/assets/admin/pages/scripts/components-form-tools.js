var ComponentsFormTools = function () {
    ...
    var handleSpinners = function () {
        ...
        $('#spinner5').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner6').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner7').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner8').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner9').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner10').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner11').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner12').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner13').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner14').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner15').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner16').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner17').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner18').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner19').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner20').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner21').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner22').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner23').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner24').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner25').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner26').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner27').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner28').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner29').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner30').spinner({value:0, step: 1, min: 0, max: 100});
        $('#spinner31').spinner({value:0, step: 1, min: 0, max: 100});
    }
